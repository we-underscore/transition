...
let gallery = [
  new THREE.TextureLoader().load('img/Bonbu_UndertheContruction02.jpg'),
  new THREE.TextureLoader().load('img/IMG_1727.JPG'),
  new THREE.TextureLoader().load('img/photo_2019-06-11_08-08-28.jpg'),
  new THREE.TextureLoader().load('img/img3.jpg'),
  new THREE.TextureLoader().load('img/img4.jpg')
];
...
function init() {
  ...
  material = new THREE.ShaderMaterial({
    ...
    uniforms: {
      ...
      texture1: {
        value: new THREE.TextureLoader().load('img/img4.jpg')
      },
      texture2: {
        value: new THREE.TextureLoader().load('img/img1.jpg')
      }
    },
    // wireframe: true,
    vertexShader: vertex,
